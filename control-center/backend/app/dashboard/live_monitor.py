...
from app.services.hls_session_health_service import HLSSessionHealthService
from app.services.webrtc_session_health_service import WebRTCSessionHealthService
...
def build_dashboard_application() -> DashboardApplication:
    ...
    hls_session_health_service = HLSSessionHealthService()
    webrtc_session_health_service = WebRTCSessionHealthService()
