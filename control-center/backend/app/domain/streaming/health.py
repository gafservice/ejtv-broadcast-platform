...
@dataclass(frozen=True, slots=True)
class HLSSessionHealth:
    """Salud observada de una sesión HLS individual."""
    ...
    def __post_init__(self) -> None:
        """Valida y normaliza la evidencia de la sesión HLS."""
...
@dataclass(frozen=True, slots=True)
class WebRTCSessionHealth:
    """Salud observada de una sesión WebRTC individual."""
    ...
    def __post_init__(self) -> None:
        """Valida y normaliza la evidencia de la sesión WebRTC."""
